...
/*
	Package simplepush is a generated protocol buffer package.
...
type Header struct {
	...
	HmacHashFunction *Header_HmacHashFunction `protobuf:"varint,3,opt,name=hmac_hash_function,enum=simplepush.Header_HmacHashFunction,def=0" json:"hmac_hash_function,omitempty"`
...
type Field struct {
	...
	ValueType        *Field_ValueType `protobuf:"varint,2,opt,name=value_type,enum=simplepush.Field_ValueType,def=0" json:"value_type,omitempty"`
...
func init() {
	proto.RegisterEnum("simplepush.Header_HmacHashFunction", Header_HmacHashFunction_name, Header_HmacHashFunction_value)
	proto.RegisterEnum("simplepush.Field_ValueType", Field_ValueType_name, Field_ValueType_value)
}
...
func (m *Header) Size() (n int) {
	...
	if m.MessageLength != nil {
		n += 1 + sovLogMessage(uint64(*m.MessageLength))
	}
	if m.HmacHashFunction != nil {
		n += 1 + sovLogMessage(uint64(*m.HmacHashFunction))
	}
	if m.HmacSigner != nil {
		l = len(*m.HmacSigner)
		n += 1 + l + sovLogMessage(uint64(l))
	}
	if m.HmacKeyVersion != nil {
		n += 1 + sovLogMessage(uint64(*m.HmacKeyVersion))
	}
	if m.Hmac != nil {
		l = len(m.Hmac)
		n += 1 + l + sovLogMessage(uint64(l))
...
func (m *Field) Size() (n int) {
	...
	if m.ValueType != nil {
		n += 1 + sovLogMessage(uint64(*m.ValueType))
	}
	...
	if len(m.ValueInteger) > 0 {
		...
		for _, e := range m.ValueInteger {
			l += sovLogMessage(uint64(e))
		}
		n += 1 + sovLogMessage(uint64(l)) + l
	}
	if len(m.ValueDouble) > 0 {
		n += 1 + sovLogMessage(uint64(len(m.ValueDouble)*8)) + len(m.ValueDouble)*8
	}
	if len(m.ValueBool) > 0 {
		n += 1 + sovLogMessage(uint64(len(m.ValueBool))) + len(m.ValueBool)*1
	}
	if m.XXX_unrecognized != nil {
		n += len(m.XXX_unrecognized)
	}
...
func (m *Message) Size() (n int) {
	...
	if m.Timestamp != nil {
		n += 1 + sovLogMessage(uint64(*m.Timestamp))
	}
	if m.Type != nil {
		l = len(*m.Type)
		n += 1 + l + sovLogMessage(uint64(l))
	...
	if m.Severity != nil {
		n += 1 + sovLogMessage(uint64(uint32(*m.Severity)))
	}
	if m.Payload != nil {
		l = len(*m.Payload)
		n += 1 + l + sovLogMessage(uint64(l))
	...
	if m.Pid != nil {
		n += 1 + sovLogMessage(uint64(uint32(*m.Pid)))
	}
	if m.Hostname != nil {
		l = len(*m.Hostname)
		n += 1 + l + sovLogMessage(uint64(l))
...
func sovLogMessage(x uint64) (n int) {
	for {
		n++
		x >>= 7
		if x == 0 {
...
func sozLogMessage(x uint64) (n int) {
	return sovLogMessage(uint64((x << 1) ^ uint64((int64(x) >> 63))))
}
...
func (m *Header) MarshalTo(data []byte) (n int, err error) {
	...
	if m.MessageLength != nil {
		data[i] = 0x8
		i++
		i = encodeVarintLogMessage(data, i, uint64(*m.MessageLength))
	}
	if m.HmacHashFunction != nil {
		data[i] = 0x18
		i++
		i = encodeVarintLogMessage(data, i, uint64(*m.HmacHashFunction))
	}
	if m.HmacSigner != nil {
		data[i] = 0x22
		i++
		i = encodeVarintLogMessage(data, i, uint64(len(*m.HmacSigner)))
		i += copy(data[i:], *m.HmacSigner)
	}
	if m.HmacKeyVersion != nil {
		data[i] = 0x28
		i++
		i = encodeVarintLogMessage(data, i, uint64(*m.HmacKeyVersion))
	}
	if m.Hmac != nil {
		data[i] = 0x32
		i++
		i = encodeVarintLogMessage(data, i, uint64(len(m.Hmac)))
...
func (m *Field) MarshalTo(data []byte) (n int, err error) {
	...
	if m.Name != nil {
		data[i] = 0xa
		i++
		i = encodeVarintLogMessage(data, i, uint64(len(*m.Name)))
		i += copy(data[i:], *m.Name)
	}
	if m.ValueType != nil {
		data[i] = 0x10
		i++
		i = encodeVarintLogMessage(data, i, uint64(*m.ValueType))
	}
	if m.Representation != nil {
		data[i] = 0x1a
		i++
		i = encodeVarintLogMessage(data, i, uint64(len(*m.Representation)))
	...
	if len(m.ValueBytes) > 0 {
		for _, b := range m.ValueBytes {
			data[i] = 0x2a
			i++
			i = encodeVarintLogMessage(data, i, uint64(len(b)))
			i += copy(data[i:], b)
		}
	}
	if len(m.ValueInteger) > 0 {
		...
		data[i] = 0x32
		i++
		i = encodeVarintLogMessage(data, i, uint64(j1))
		i += copy(data[i:], data2[:j1])
	}
	if len(m.ValueDouble) > 0 {
		data[i] = 0x3a
		i++
		i = encodeVarintLogMessage(data, i, uint64(len(m.ValueDouble)*8))
	...
	if len(m.ValueBool) > 0 {
		data[i] = 0x42
		i++
		i = encodeVarintLogMessage(data, i, uint64(len(m.ValueBool)))
...
func (m *Message) MarshalTo(data []byte) (n int, err error) {
	...
	if m.Uuid != nil {
		data[i] = 0xa
		i++
		i = encodeVarintLogMessage(data, i, uint64(len(m.Uuid)))
		i += copy(data[i:], m.Uuid)
	}
	if m.Timestamp != nil {
		data[i] = 0x10
		i++
		i = encodeVarintLogMessage(data, i, uint64(*m.Timestamp))
	}
	if m.Type != nil {
		data[i] = 0x1a
		i++
		i = encodeVarintLogMessage(data, i, uint64(len(*m.Type)))
		i += copy(data[i:], *m.Type)
	}
	if m.Logger != nil {
		data[i] = 0x22
		i++
		i = encodeVarintLogMessage(data, i, uint64(len(*m.Logger)))
		i += copy(data[i:], *m.Logger)
	}
	if m.Severity != nil {
		data[i] = 0x28
		i++
		i = encodeVarintLogMessage(data, i, uint64(uint32(*m.Severity)))
	}
	if m.Payload != nil {
		data[i] = 0x32
		i++
		i = encodeVarintLogMessage(data, i, uint64(len(*m.Payload)))
		i += copy(data[i:], *m.Payload)
	}
	if m.EnvVersion != nil {
		data[i] = 0x3a
		i++
		i = encodeVarintLogMessage(data, i, uint64(len(*m.EnvVersion)))
		i += copy(data[i:], *m.EnvVersion)
	}
	if m.Pid != nil {
		data[i] = 0x40
		i++
		i = encodeVarintLogMessage(data, i, uint64(uint32(*m.Pid)))
	}
	if m.Hostname != nil {
		data[i] = 0x4a
		i++
		i = encodeVarintLogMessage(data, i, uint64(len(*m.Hostname)))
	...
	if len(m.Fields) > 0 {
		for _, msg := range m.Fields {
			data[i] = 0x52
			i++
			i = encodeVarintLogMessage(data, i, uint64(msg.Size()))
...
func encodeFixed64LogMessage(data []byte, offset int, v uint64) int {
	data[offset] = uint8(v)
...
func encodeFixed32LogMessage(data []byte, offset int, v uint32) int {
	data[offset] = uint8(v)
	data[offset+1] = uint8(v >> 8)
	data[offset+2] = uint8(v >> 16)
	data[offset+3] = uint8(v >> 24)
...
func encodeVarintLogMessage(data []byte, offset int, v uint64) int {
	for v >= 1<<7 {
